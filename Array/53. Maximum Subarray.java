...
the sub problem(or the state of each sub problem).
...
In other words, I can’t find a way to divided the original problem into the
...
because there’s a limitation that A[i] should be contained in that sequence and
