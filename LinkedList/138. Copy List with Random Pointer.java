...
现在我们把结点的随机指针都接好了，最后一次扫描我们把链表拆成两个，第一个还原原链表，而第二个就是我们要求的复制链表。
...
总共需要iterate 2遍：
1st：用old list的next指针，建hashmap以及 new list node
2nditerate HashMap,复制random pointer和其next pointer
*/
